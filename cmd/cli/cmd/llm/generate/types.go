...
type GeneratorConfig struct {
	K8s       K8sConfig    `yaml:"K8sConfig"`
	Workers   WorkerConfig `yaml:"WorkerConfig"`
...
// DynConfig holds dynamic configuration settings
type DynConfig struct {
	Mode        string `yaml:"mode"`
	EnableRoute bool   `yaml:"enable_route"`
}

// WorkerConfig holds the number of workers for each role
