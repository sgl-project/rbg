...
type StatefulInstanceControlObjectManager interface {
	CreateInstance(ctx context.Context, instance *workloadsv1alpha2.RoleInstance) error
	GetInstance(namespace, instanceName string) (*workloadsv1alpha2.RoleInstance, error)
	UpdateInstance(instance *workloadsv1alpha2.RoleInstance) error
	DeleteInstance(instance *workloadsv1alpha2.RoleInstance) error
}
...
func NewStatefulInstanceControl(
	...
	roleInstanceLister roleinstancelisters.RoleInstanceLister,
	recorder record.EventRecorder,
) *StatefulInstanceControl {
	return &StatefulInstanceControl{&realStatefulInstanceControlObjectManager{client, roleInstanceLister}, recorder}
}
...
func (om *realStatefulInstanceControlObjectManager) CreateInstance(ctx context.Context, instance *workloadsv1alpha2.RoleInstance) error {
	return om.client.Create(ctx, instance)
}

func (om *realStatefulInstanceControlObjectManager) GetInstance(namespace, instanceName string) (*workloadsv1alpha2.RoleInstance, error) {
	return om.roleInstanceLister.RoleInstances(namespace).Get(instanceName)
}

func (om *realStatefulInstanceControlObjectManager) UpdateInstance(instance *workloadsv1alpha2.RoleInstance) error {
	return om.client.Update(context.TODO(), instance)
}

func (om *realStatefulInstanceControlObjectManager) DeleteInstance(instance *workloadsv1alpha2.RoleInstance) error {
	return om.client.Delete(context.TODO(), instance)
}

func (sic *StatefulInstanceControl) CreateStatefulInstance(ctx context.Context, set *workloadsv1alpha2.RoleInstanceSet, instance *workloadsv1alpha2.RoleInstance) error {
...
func (sic *StatefulInstanceControl) UpdateStatefulInstance(set *workloadsv1alpha2.RoleInstanceSet, instance *workloadsv1alpha2.RoleInstance) error {
...
func (sic *StatefulInstanceControl) DeleteStatefulInstance(set *workloadsv1alpha2.RoleInstanceSet, instance *workloadsv1alpha2.RoleInstance) error {
	err := sic.objectMgr.DeleteInstance(instance)
	sic.recordInstanceEvent("delete", set, instance, err)
	return err
}

// recordInstanceEvent records an event for verb applied to a RoleInstance in a RoleInstanceSet. If err is nil the generated event will
// have a reason of v1.EventTypeNormal. If err is not nil the generated event will have a reason of v1.EventTypeWarning.
func (sic *StatefulInstanceControl) recordInstanceEvent(verb string, set *workloadsv1alpha2.RoleInstanceSet, instance *workloadsv1alpha2.RoleInstance, err error) {
	titleVerb := cases.Title(language.English, cases.Compact).String(verb)
	if err == nil {
		reason := fmt.Sprintf("Successful%s", titleVerb)
		message := fmt.Sprintf("%s RoleInstance %s in RoleInstanceSet %s successful",
		...
		message := fmt.Sprintf("%s RoleInstance %s in RoleInstanceSet %s failed error: %s",
