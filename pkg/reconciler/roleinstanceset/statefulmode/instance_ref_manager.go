...
type InstanceControlInterface interface {
	...
	CreateInstance(ctx context.Context, namespace string, instance *workloadsv1alpha2.RoleInstance, object metav1.Object) error
...
func (r *realInstanceControl) CreateInstance(ctx context.Context, namespace string, instance *workloadsv1alpha2.RoleInstance, object metav1.Object) error {
...
func (m *InstanceControllerRefManager) ClaimInstances(ctx context.Context, instances []*workloadsv1alpha2.RoleInstance, filters ...func(*workloadsv1alpha2.RoleInstance) bool) ([]*workloadsv1alpha2.RoleInstance, error) {
	var claimed []*workloadsv1alpha2.RoleInstance
	var errlist []error

	match := func(obj *workloadsv1alpha2.RoleInstance) bool {
		// Check selector
	...
	adopt := func(obj *workloadsv1alpha2.RoleInstance) bool {
	...
	release := func(obj *workloadsv1alpha2.RoleInstance) bool {
		controllerRef := metav1.GetControllerOf(obj)
