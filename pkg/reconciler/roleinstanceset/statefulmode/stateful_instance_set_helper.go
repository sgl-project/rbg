...
func newRevision(set *workloadsv1alpha2.RoleInstanceSet, revision int64, collisionCount *int32) (*apps.ControllerRevision, error) {
...
func getPatch(set *workloadsv1alpha2.RoleInstanceSet) ([]byte, error) {
...
func ApplyRevision(set *workloadsv1alpha2.RoleInstanceSet, revision *apps.ControllerRevision) (*workloadsv1alpha2.RoleInstanceSet, error) {
	clone := set.DeepCopy()
...
func updateStatus(
	...
	instanceLists ...[]*workloadsv1alpha2.RoleInstance) {
...
func isInstanceAvailable(instance *workloadsv1alpha2.RoleInstance, minReadySeconds int32) bool {
...
func getMinReadySeconds(set *workloadsv1alpha2.RoleInstanceSet) int32 {
	return set.Spec.MinReadySeconds
}

// getScaleMaxUnavailable returns the maximum unavailable instances during scaling
func getScaleMaxUnavailable(set *workloadsv1alpha2.RoleInstanceSet) (int, error) {
...
func runForAll(items interface{}, fn func(int) (bool, error), monotonic bool) (bool, error) {
	var length int
	switch v := items.(type) {
	case []*workloadsv1alpha2.RoleInstance:
		length = len(v)
	default:
