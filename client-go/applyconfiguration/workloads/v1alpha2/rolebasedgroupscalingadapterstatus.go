...
func (b *RoleBasedGroupScalingAdapterStatusApplyConfiguration) WithPhase(value constants.AdapterPhase) *RoleBasedGroupScalingAdapterStatusApplyConfiguration {
	b.Phase = &value
	return b
}
