...
type RolloutStrategyApplyConfiguration struct {
	Type          *workloadsv1alpha2.RolloutStrategyType `json:"type,omitempty"`
...
func (b *RolloutStrategyApplyConfiguration) WithType(value workloadsv1alpha2.RolloutStrategyType) *RolloutStrategyApplyConfiguration {
	b.Type = &value
	return b
}
