...
func (b *RoleSpecApplyConfiguration) WithStandalonePattern(value *StandalonePatternApplyConfiguration) *RoleSpecApplyConfiguration {
	b.PatternApplyConfiguration.StandalonePattern = value
	return b
}
...
func (b *RoleSpecApplyConfiguration) WithLeaderWorkerPattern(value *LeaderWorkerPatternApplyConfiguration) *RoleSpecApplyConfiguration {
	b.PatternApplyConfiguration.LeaderWorkerPattern = value
	return b
}
