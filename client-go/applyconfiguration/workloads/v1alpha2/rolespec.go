...
type RoleSpecApplyConfiguration struct {
	...
	Pattern         *PatternApplyConfiguration            `json:"pattern,omitempty"`
...
func (b *RoleSpecApplyConfiguration) WithPattern(value *PatternApplyConfiguration) *RoleSpecApplyConfiguration {
	b.Pattern = value
	return b
}
