...
// apply.
func StandalonePattern() *StandalonePatternApplyConfiguration {
	return &StandalonePatternApplyConfiguration{}
}

// WithTemplate sets the Template field in the declarative configuration to the given value
// and returns the receiver, so that objects can be built by chaining "With" function invocations.
// If called multiple times, the Template field is set to the value of the last call.
func (b *StandalonePatternApplyConfiguration) WithTemplate(value *v1.PodTemplateSpecApplyConfiguration) *StandalonePatternApplyConfiguration {
