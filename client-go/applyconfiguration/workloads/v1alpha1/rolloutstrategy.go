...
type RolloutStrategyApplyConfiguration struct {
	Type          *workloadsv1alpha1.RolloutStrategyType `json:"type,omitempty"`
...
func (b *RolloutStrategyApplyConfiguration) WithType(value workloadsv1alpha1.RolloutStrategyType) *RolloutStrategyApplyConfiguration {
	b.Type = &value
	return b
}
...
func (b *RolloutStrategyApplyConfiguration) WithRollingUpdate(value *RollingUpdateApplyConfiguration) *RolloutStrategyApplyConfiguration {
