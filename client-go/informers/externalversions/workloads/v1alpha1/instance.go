...
type InstanceInformer interface {
	...
	Lister() workloadsv1alpha1.InstanceLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.WorkloadsV1alpha1().Instances(namespace).List(context.Background(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.WorkloadsV1alpha1().Instances(namespace).Watch(context.Background(), options)
			},
			ListWithContextFunc: func(ctx context.Context, options v1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.WorkloadsV1alpha1().Instances(namespace).List(ctx, options)
			},
			WatchFuncWithContext: func(ctx context.Context, options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.WorkloadsV1alpha1().Instances(namespace).Watch(ctx, options)
			},
		},
		&apiworkloadsv1alpha1.Instance{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *instanceInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apiworkloadsv1alpha1.Instance{}, f.defaultInformer)
}

func (f *instanceInformer) Lister() workloadsv1alpha1.InstanceLister {
	return workloadsv1alpha1.NewInstanceLister(f.Informer().GetIndexer())
}
