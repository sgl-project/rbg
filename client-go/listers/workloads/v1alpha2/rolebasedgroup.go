...
type roleBasedGroupLister struct {
	listers.ResourceIndexer[*workloadsv1alpha2.RoleBasedGroup]
}
...
func NewRoleBasedGroupLister(indexer cache.Indexer) RoleBasedGroupLister {
	return &roleBasedGroupLister{listers.New[*workloadsv1alpha2.RoleBasedGroup](indexer, workloadsv1alpha2.Resource("rolebasedgroup"))}
}

// RoleBasedGroups returns an object that can list and get RoleBasedGroups.
func (s *roleBasedGroupLister) RoleBasedGroups(namespace string) RoleBasedGroupNamespaceLister {
	return roleBasedGroupNamespaceLister{listers.NewNamespaced[*workloadsv1alpha2.RoleBasedGroup](s.ResourceIndexer, namespace)}
}
