...
| `leaderWorkerPattern.restartPolicyConfig` | object | No | `type: RecreateRoleInstanceOnPodRestart` | Restart policy config: `type` (`None` or `RecreateRoleInstanceOnPodRestart`), `baseDelaySeconds` (default: 30), `maxDelaySeconds` (default: 600) |
