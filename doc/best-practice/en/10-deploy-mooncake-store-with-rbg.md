...
> **Note**: The following examples use the SGLang engine (`lmsysorg/sglang:v0.5.5`) to demonstrate Mooncake Store integration. Mooncake Store also supports other inference engines (such as vLLM).
>
