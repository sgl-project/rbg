...
| --- | --- | --- |
| 1 | [Multi-Role Configuration & Role Topology](01-multi-roles.md) | 4 deployment topologies (Aggregated/PD-disaggregated × single-node/multi-node) |
...
| 4 | [In-Place Update and In-Place Scheduling](04-inplace-update-and-scheduling.md) | Container-level fast updates and node affinity scheduling |
| 5 | [Port Allocation and Service Discovery](05-port-allocation-and-service-discovery.md) | DNS, environment variables, ConfigMap, dynamic ports |
| 6 | [Configuring Autoscaling for RBG Services](06-configuring-autoscaling.md) | HPA/KEDA/RBG Planner — three scaling solutions |
| 7 | [Accelerating Service Readiness with Warmup](07-accelerate-readiness-with-warmup.md) | Pre-warming images, models, pre-compiled files |
| 8 | [Multi-Role Coordinated Policy (CoordinatedPolicy)](08-coordinated-policy.md) | Controlling scaling and upgrade synchronization across roles |
