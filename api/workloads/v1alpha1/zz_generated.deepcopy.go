...
func (in *Coordination) DeepCopyInto(out *Coordination) {
	*out = *in
	...
	if in.RolloutStrategy != nil {
		...
		*out = new(CoordinationRolloutStrategy)
		(*in).DeepCopyInto(*out)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CoordinationRolloutStrategy) DeepCopyInto(out *CoordinationRolloutStrategy) {
	*out = *in
	if in.MaxSkew != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CoordinationRolloutStrategy.
func (in *CoordinationRolloutStrategy) DeepCopy() *CoordinationRolloutStrategy {
	if in == nil {
		return nil
	}
	out := new(CoordinationRolloutStrategy)
