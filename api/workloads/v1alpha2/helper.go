...
func (r *RoleSpec) IsStandalonePattern() bool {
	...
	return r.Pattern.StandalonePattern != nil
}
...
func (r *RoleSpec) IsLeaderWorkerPattern() bool {
	...
	return r.Pattern.LeaderWorkerPattern != nil
}
...
func (r *RoleSpec) GetStandalonePattern() *StandalonePattern {
	...
	return r.Pattern.StandalonePattern
}
...
func (r *RoleSpec) GetLeaderWorkerPattern() *LeaderWorkerPattern {
	...
	return r.Pattern.LeaderWorkerPattern
}
...
func (r *RoleSpec) GetTemplate() *corev1.PodTemplateSpec {
	...
	if r.Pattern.StandalonePattern != nil {
		return r.Pattern.StandalonePattern.TemplateSource.Template
	}
	if r.Pattern.LeaderWorkerPattern != nil {
		return r.Pattern.LeaderWorkerPattern.TemplateSource.Template
	}
	return nil
}
...
func (r *RoleSpec) GetTemplateRef() *TemplateRef {
	...
	if r.Pattern.StandalonePattern != nil {
		return r.Pattern.StandalonePattern.TemplateSource.TemplateRef
	}
	if r.Pattern.LeaderWorkerPattern != nil {
		return r.Pattern.LeaderWorkerPattern.TemplateSource.TemplateRef
	}
	return nil
}
...
func (r *RoleSpec) GetLeaderTemplatePatch() *runtime.RawExtension {
	if r.Pattern == nil || r.Pattern.LeaderWorkerPattern == nil {
		return nil
	}
	return r.Pattern.LeaderWorkerPattern.LeaderTemplatePatch
}
...
func (r *RoleSpec) GetWorkerTemplatePatch() *runtime.RawExtension {
	...
	return r.Pattern.LeaderWorkerPattern.WorkerTemplatePatch
}
...
func (r *RoleSpec) GetLeaderWorkerSize() *int32 {
	...
	return r.Pattern.LeaderWorkerPattern.Size
}
