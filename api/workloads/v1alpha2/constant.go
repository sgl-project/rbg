...
// NOTE: This type must remain in the API package as it's used in CRD status fields.
// Other constants (labels, annotations, workload types) are defined in pkg/constants.
