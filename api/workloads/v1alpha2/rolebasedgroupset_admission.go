...
func (v *RoleBasedGroupSetValidator) ValidateCreate(_ context.Context, obj runtime.Object) (admission.Warnings, error) {
	...
	errs := v.validateSpec(rbgs)
	if err := validateNoRoleScalingAdapter(groupSetRolesFieldPath, rbgs.Spec.GroupTemplate.Spec.Roles); err != nil {
...
// validateNoRoleScalingAdapter runs on create only.
