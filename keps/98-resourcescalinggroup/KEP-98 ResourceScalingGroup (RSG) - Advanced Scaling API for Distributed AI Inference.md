...
* [Proposal](#proposal)
  ...
  + [2. Orphaned Resources](#2-orphaned-resources)
...
type TargetResource struct {
	// Name serves as the identifier for this resource definition.
	...
	// SubResources allows targeting specific internal roles (e.g., for RBG).
	// +optional
	SubResources []SubResource `json:"subResources,omitempty"`
}

// SubResource defines specific paths/roles within a custom resource.
type SubResource struct {
	// RoleName identifies a specific role within a complex CRD.
	// +kubebuilder:validation:Required
...
type GroupConfig struct {
	// GroupName is used as a prefix/identifier for the group.
	// +kubebuilder:validation:Required
